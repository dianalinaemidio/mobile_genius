       ...
       <div class="container-form">
           ...
           <div class="form-group">
               ...
               <input type="text" id="cpf" name="cpf" pattern="\d{3}\.\d{3}\.\d{3}-\d{2}"
                   title="Digite um CPF válido (ex: 123.456.789-01)" value="${param.cpf}" required>
               <c:if test="${not empty requestScope.cpfError}">
                   <div class="error">${requestScope.cpfError}</div>
               </c:if>
           </div>

           <div class="form-group">
               <label for="datanascimento">Data de Nascimento</label>
               <input type="text" id="datanascimento" name="datanascimento" pattern="\d{2}-\d{2}-\d{4}"
                   title="Digite uma data válida no formato dd-MM-yyyy (ex: 01-01-0101)" value="${param.datanascimento}" required>
               <c:if test="${not empty requestScope.dataNascimentoError}">
                   <div class="error">${requestScope.dataNascimentoError}</div>
               </c:if>
           </div>

           <!-- Adicione as outras mensagens de erro aqui -->
           ...
           <div class="form-group">
               ...
               <input type="text" id="numerocelular" name="numerocelular" pattern="[0-9]{10,11}"
                   title="Digite um número de celular válido" value="${param.numerocelular}" required>
               <c:if test="${not empty requestScope.celularError}">
                   <div class="error">${requestScope.celularError}</div>
               </c:if>
           </div>
